...
let dataArr = [{login: "Egor", password: "qwer", hobby: "IT", age: 19},
{login: "Ivan", password: "asdf", hobby: "TV", age: 18},
{login: "Vasya", password: "zxcv", hobby: "Computer games", age: 20}];
...
// Авторизация
app.get("user-info/autorization", )
