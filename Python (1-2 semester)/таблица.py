...
# выводит график и таблицу значений  функции
# y_min = x ** 8 - 5 * x ** 7 + 3 * x ** 6 + 8 * x ** 5 - 35 * x ** 4 + 73 * x ** 3 - 6 * x ** 2 + 23 * x + 7

# x_0, x, v - начальные переменные
# x_n_0, x_n - конечные переменные
# y_min, y_max = минимальные и максимальные значения переменной y
# d - шаг
# dep - переменная, отвечающая за построение графика и за его масштаб
# s_1 - строчка, отвечающая за расположение *
# m - строчка, отвечающая за ось координат y
